...
class MerkTest extends TestCase
{
    ...
    public function test_user_dapat_melihat_merk_di_home()
    {
        Kategori::create([
            'nama_kategori' => 'Semen',
            'prefix' => 'semen',
    ...
    public function test_user_dapat_melihat_isi_merk_di_home()
    {
    ...
    public function test_user_dapat_mengklik_produk_dari_merk()
    {
        User::create([
